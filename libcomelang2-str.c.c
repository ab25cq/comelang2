...
memset(&right_value36, 0, sizeof(void*));
    ...
    __freed_obj__ = 0;
    if(_if_conditional5=self->re==((void*)0),    __freed_obj__ = 0, 
    _if_conditional5) {
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
    if(_if_conditional6=reg&&reg->str,    __freed_obj__ = 0, 
    _if_conditional6) {
        if(reg->str && !__freed_obj__) { reg->str = come_decrement_ref_count(reg->str, (void*)0, (void*)0, 0, 0, 0); }
        __freed_obj__ = 0;
    }
    __freed_obj__ = 0;
    if(_if_conditional7=reg&&reg->re,    __freed_obj__ = 0, 
    _if_conditional7) {
        free(reg->re);
        __freed_obj__ = 0;
    }
...
memset(&erro_ofs_10, 0, sizeof(int));
    ...
    __freed_obj__ = 0;
    if(_if_conditional9=result_8->re==((void*)0),    __freed_obj__ = 0, 
    _if_conditional9) {
...
memset(&str2_92, 0, sizeof(char*));
    ...
    _while_condtional6) {
        ...
        _if_conditional33) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional34=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,            __freed_obj__ = 0, 
            _if_conditional34) {
            ...
            _if_conditional38) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional39=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,                __freed_obj__ = 0, 
                _if_conditional39) {
...
memset(&str2_117, 0, sizeof(char*));
    ...
    _while_condtional7) {
        ...
        _if_conditional41) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional42=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,            __freed_obj__ = 0, 
            _if_conditional42) {
            ...
            _if_conditional45) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional46=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,                __freed_obj__ = 0, 
                _if_conditional46) {
...
memset(&str2_144, 0, sizeof(char*));
    ...
    _while_condtional8) {
        ...
        _if_conditional49) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional50=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,            __freed_obj__ = 0, 
            _if_conditional50) {
            ...
            _if_conditional52) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional54=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,                __freed_obj__ = 0, 
                _if_conditional54) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional55=offset_124<charp_length(self),    __freed_obj__ = 0, 
    _if_conditional55) {
        ...
        __freed_obj__ = 0;
        if(_if_conditional56=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,        __freed_obj__ = 0, 
        _if_conditional56) {
...
memset(&str2_169, 0, sizeof(char*));
    ...
    _while_condtional9) {
        ...
        _if_conditional57) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional58=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,            __freed_obj__ = 0, 
            _if_conditional58) {
            ...
            _if_conditional60) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional62=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,                __freed_obj__ = 0, 
                _if_conditional62) {
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
    if(_if_conditional64=strcmp(left->str,right->str)!=0,    __freed_obj__ = 0, 
    _if_conditional64) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional65=left->ignore_case!=right->ignore_case,    __freed_obj__ = 0, 
    _if_conditional65) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional66=left->multiline!=right->multiline,    __freed_obj__ = 0, 
    _if_conditional66) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional67=left->global!=right->global,    __freed_obj__ = 0, 
    _if_conditional67) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional68=left->extended!=right->extended,    __freed_obj__ = 0, 
    _if_conditional68) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional69=left->dotall!=right->dotall,    __freed_obj__ = 0, 
    _if_conditional69) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional70=left->anchored!=right->anchored,    __freed_obj__ = 0, 
    _if_conditional70) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional71=left->dollar_endonly!=right->dollar_endonly,    __freed_obj__ = 0, 
    _if_conditional71) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional72=left->ungreedy!=right->ungreedy,    __freed_obj__ = 0, 
    _if_conditional72) {
    ...
    __freed_obj__ = 0;
    if(_if_conditional73=left->options!=right->options,    __freed_obj__ = 0, 
    _if_conditional73) {
...
memset(&right_value136, 0, sizeof(void*));
    ...
    _while_condtional15) {
        ...
        _if_conditional105) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional107=!reg->global,            __freed_obj__ = 0, 
            _if_conditional107) {
...
memset(&right_value143, 0, sizeof(void*));
    ...
    _while_condtional16) {
        ...
        _if_conditional108) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional110=!reg->global,            __freed_obj__ = 0, 
            _if_conditional110) {
...
memset(&right_value149, 0, sizeof(void*));
    ...
    0;    _for_condtionalA39=    i_303<charp_length(self) ,    __freed_obj__ = 0, 
    ...
    __freed_obj__ = 0;
    if(_if_conditional113=buffer_length(buf_302)!=0,    __freed_obj__ = 0, 
    _if_conditional113) {
...
memset(&str_344, 0, sizeof(char*));
    ...
    __freed_obj__ = 0;
    if(_if_conditional122=offset_330<charp_length(self),    __freed_obj__ = 0, 
    _if_conditional122) {
...
memset(&str_381, 0, sizeof(char*));
    ...
    __freed_obj__ = 0;
    if(_if_conditional129=offset_366<charp_length(self),    __freed_obj__ = 0, 
    _if_conditional129) {
...
memset(&right_value187, 0, sizeof(void*));
    ...
    _while_condtional23) {
        ...
        _if_conditional136) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional137=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,            __freed_obj__ = 0, 
            _if_conditional137) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional139=!reg->global,            __freed_obj__ = 0, 
            _if_conditional139) {
            ...
            _if_conditional140) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional142=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,                __freed_obj__ = 0, 
                _if_conditional142) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional143=!reg->global,                __freed_obj__ = 0, 
                _if_conditional143) {
...
memset(&right_value209, 0, sizeof(void*));
    ...
    _while_condtional24) {
        ...
        _if_conditional144) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional145=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,            __freed_obj__ = 0, 
            _if_conditional145) {
            ...
            __freed_obj__ = 0;
            if(_if_conditional147=!reg->global,            __freed_obj__ = 0, 
            _if_conditional147) {
            ...
            _if_conditional149) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional151=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,                __freed_obj__ = 0, 
                _if_conditional151) {
                ...
                __freed_obj__ = 0;
                if(_if_conditional152=!reg->global,                __freed_obj__ = 0, 
                _if_conditional152) {
...
memset(&right_value212, 0, sizeof(void*));
    ...
    __freed_obj__ = 0;
    if(_if_conditional154=result_479[string_length(result_479)-1]==10,    __freed_obj__ = 0, 
    _if_conditional154) {
