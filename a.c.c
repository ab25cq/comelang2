...
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
    (come_push_stackframe("a.c", 5),puts("AAA"));
    come_pop_stackframe();
    __freed_obj__ = 0;
    __result12__ = 0;
    __freed_obj__ = 0;
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
    (come_push_stackframe("a.c", 11),fun());
    come_pop_stackframe();
    __freed_obj__ = 0;
    (come_push_stackframe("a.c", 12),puts("BBB"));
    come_pop_stackframe();
    __freed_obj__ = 0;
    (come_push_stackframe("a.c", 13),fun());
    come_pop_stackframe();
    __freed_obj__ = 0;
    (come_push_stackframe("a.c", 14),stackframe());
    come_pop_stackframe();
    __freed_obj__ = 0;
    __result13__ = (come_push_stackframe("a.c", 15),fun());
    come_pop_stackframe();
    __freed_obj__ = 0;
    return __result13__;
    __freed_obj__ = 0;
...
memset(&__freed_obj__, 0, sizeof(_Bool));
come_heap_init(0, 1);
    (come_push_stackframe("a.c", 20),fun2());
    come_pop_stackframe();
    __freed_obj__ = 0;
    __result14__ = 0;
    __freed_obj__ = 0;
