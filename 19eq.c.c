...
memset(&right_value28, 0, sizeof(void*));
                    ...
                    _while_condtional4) {
                        (come_push_stackframe("./comelang2.h", 197),__exception_result_var_b8=list$1sTypeph_add(((struct list$1sTypeph*)come_null_check(result_20, "./comelang2.h", 197)),(struct sType*)come_increment_ref_count(((struct sType*)(right_value28=sType_clone(((struct list_item$1sTypeph*)come_null_check(it_21, "./comelang2.h", 197))->item))))), come_pop_stackframe(), __exception_result_var_b8);
...
memset(&litem_24, 0, sizeof(struct list_item$1sTypeph*));
                            if(_if_conditional47=((struct list$1sTypeph*)come_null_check(self, "./comelang2.h", 206))->len==0,                            __freed_obj__ = 0, 
                            _if_conditional47) {
                                ...
                                if(_if_conditional48=((struct list$1sTypeph*)come_null_check(self, "./comelang2.h", 216))->len==1,                                __freed_obj__ = 0, 
                                _if_conditional48) {
...
memset(&right_value35, 0, sizeof(void*));
                    ...
                    __freed_obj__ = 0;
                    result_25=(struct list$1sNodeph*)come_increment_ref_count((come_push_stackframe("./comelang2.h", 193),__exception_result_var_b9=((struct list$1sNodeph*)(right_value31=list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)come_null_check(((struct list$1sNodeph*)(right_value30=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "./comelang2.h", 193))), "./comelang2.h", 193)))))), come_pop_stackframe(), __exception_result_var_b9));
                    ...
                    _while_condtional5) {
                        (come_push_stackframe("./comelang2.h", 197),__exception_result_var_b10=list$1sNodeph_add(((struct list$1sNodeph*)come_null_check(result_25, "./comelang2.h", 197)),(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value35=sNode_clone(((struct list_item$1sNodeph*)come_null_check(it_26, "./comelang2.h", 197))->item))))), come_pop_stackframe(), __exception_result_var_b10);
...
memset(&litem_29, 0, sizeof(struct list_item$1sNodeph*));
                            if(_if_conditional51=((struct list$1sNodeph*)come_null_check(self, "./comelang2.h", 206))->len==0,                            __freed_obj__ = 0, 
                            _if_conditional51) {
                                ...
                                if(_if_conditional52=((struct list$1sNodeph*)come_null_check(self, "./comelang2.h", 216))->len==1,                                __freed_obj__ = 0, 
                                _if_conditional52) {
...
memset(&right_value43, 0, sizeof(void*));
                    ...
                    _while_condtional6) {
                        (come_push_stackframe("./comelang2.h", 197),__exception_result_var_b12=list$1charph_add(((struct list$1charph*)come_null_check(result_30, "./comelang2.h", 197)),(char*)come_increment_ref_count(((char*)(right_value43=string_clone(((struct list_item$1charph*)come_null_check(it_31, "./comelang2.h", 197))->item))))), come_pop_stackframe(), __exception_result_var_b12);
...
memset(&litem_34, 0, sizeof(struct list_item$1charph*));
                            if(_if_conditional57=((struct list$1charph*)come_null_check(self, "./comelang2.h", 206))->len==0,                            __freed_obj__ = 0, 
                            _if_conditional57) {
                                ...
                                if(_if_conditional58=((struct list$1charph*)come_null_check(self, "./comelang2.h", 216))->len==1,                                __freed_obj__ = 0, 
                                _if_conditional58) {
...
memset(&litem_37, 0, sizeof(struct list_item$1CVALUEph*));
            if(_if_conditional98=((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 276))->len==0,            __freed_obj__ = 0, 
            _if_conditional98) {
                ...
                if(_if_conditional100=((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 286))->len==1,                __freed_obj__ = 0, 
                _if_conditional100) {
