...
memset(&__freed_obj__, 0, sizeof(_Bool));
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    (gCallerSName[0] = "01main.c", gCallerSLine[0] = 5,puts("HELLO COMELANG"));
    __freed_obj__ = 0;
    __result12__ = 0;
    __freed_obj__ = 0;
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
come_heap_init(0);
    __result13__ = (gCallerSName[0] = "01main.c", gCallerSLine[0] = 12,come_main_v2(argc,argv));
    __freed_obj__ = 0;
    memcpy(gCallerSName, __caller_sname__, sizeof(char*)*10);    memcpy(gCallerSLine, __caller_sline__, sizeof(int)*10);    come_heap_final(1);
    return __result13__;
    __freed_obj__ = 0;
come_heap_final(0);
memcpy(gCallerSName, __caller_sname__, sizeof(char*)*10);memcpy(gCallerSLine, __caller_sline__, sizeof(int)*10);}
