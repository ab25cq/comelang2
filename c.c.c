...
come_heap_init(0, 1);
    (come_push_stackframe("c.c", 8),__exception_result_var_b1=puts(((char*)(right_value10=xsprintf("        AAA\n        BBB\n")))), come_pop_stackframe(), __exception_result_var_b1);
    __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 0, right_value10);
    if(right_value10 && right_value10 != __result_obj__ && !__freed_obj__) { right_value10 = come_decrement_ref_count(right_value10, (void*)0, (void*)0, 1, 0, 0); }
    __right_value_freed_obj[0] = right_value10;
    __freed_obj__ = 0;
    (come_push_stackframe("c.c", 10),__exception_result_var_b2=puts("AAA"), come_pop_stackframe(), __exception_result_var_b2);
    __freed_obj__ = 0;
    __result13__ = 0;
    __freed_obj__ = 0;
    come_heap_final();
