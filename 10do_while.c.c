...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    ...
    ((struct sDoWhileNode*)come_null_check(self, "10do_while.c", 16))->sname=(char*)come_increment_ref_count(((char*)(right_value10=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 16,__builtin_string(((struct sInfo*)come_null_check(info, "10do_while.c", 16))->sname)))));
    ...
    ((struct sDoWhileNode*)come_null_check(self, "10do_while.c", 18))->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value12=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 18,sNode_clone(expression_node)))));
    ...
    ((struct sDoWhileNode*)come_null_check(self, "10do_while.c", 19))->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value84=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 19,sBlock_clone(block)))));
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    __result74__ = __result_obj__ = ((char*)(right_value85=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 31,__builtin_string("sDoWhileNode"))));
    __freed_obj__ = 0;
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    ...
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 41,add_come_code(info,"do {\n"));
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 43,transpile_block(block_91,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1));
    __freed_obj__ = 0;
    ...
    __freed_obj__ = 0;
    conditional_value_93=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value86=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 54,get_value_from_stack(-1,info)))));
    ...
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 55,dec_stack_ptr(1,info));
    __freed_obj__ = 0;
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 58,add_come_code_at_function_head(info,"_Bool _do_while_condtional%d;\n",++num_while_condtional_94));
    __freed_obj__ = 0;
    num_while_conditional_stack_95=num_while_condtional_94;
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 61,add_come_code(info,"} while(_do_while_condtional%d=%s,",num_while_condtional_94,((struct CVALUE*)come_null_check(conditional_value_93, "10do_while.c", 61))->c_value));
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 62,add_last_code_to_source_with_comma(info));
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 63,free_right_value_objects(info,(_Bool)1));
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 64,add_come_code(info,"_do_while_condtional%d);\n",num_while_conditional_stack_95));
    __freed_obj__ = 0;
    (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 66,transpiler_clear_last_code(info));
    __freed_obj__ = 0;
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    __result78__ = __result_obj__ = ((char*)(right_value87=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 80,__builtin_string(((struct sDoWhileNode*)come_null_check(self, "10do_while.c", 80))->sname))));
    __freed_obj__ = 0;
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    if(_if_conditional180=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 108, charp_operator_equals(buf,"do")),    __freed_obj__ = 0, 
    _if_conditional180) {
        sname_96=(char*)come_increment_ref_count(((char*)(right_value88=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 86,string_clone(((struct sInfo*)come_null_check(info, "10do_while.c", 86))->sname)))));
        if(right_value88 && right_value88 != __result_obj__ && !__freed_obj__) { right_value88 = come_decrement_ref_count(right_value88, (void*)0, (void*)0, 1, 0, 0); }
        __freed_obj__ = 0;
        sline_97=((struct sInfo*)come_null_check(info, "10do_while.c", 87))->sline;
        __freed_obj__ = 0;
        block_98=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value89=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 89,parse_block(info,(_Bool)0)))));
        ...
        buf2_100=(char*)come_increment_ref_count(optional$2charphbool_value((come_push_stackframe("10do_while.c", 91),((struct optional$2charphbool*)(right_value90=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 91,parse_word(info)))))));
        come_pop_stackframe();
        ...
        __freed_obj__ = 0;
        if(_if_conditional183=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 98, string_operator_not_equals(buf2_100,"while")),        __freed_obj__ = 0, 
        _if_conditional183) {
            (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 94,err_msg(info,"require while"));
            __freed_obj__ = 0;
            (gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 95,exit(2));
            __freed_obj__ = 0;
        }
        __freed_obj__ = 0;
        come_clear_stackframe();
        optional$2intbool_value((come_push_stackframe("10do_while.c", 98),((struct optional$2intbool*)(right_value91=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 98,expected_next_character(40,info))))));
        come_pop_stackframe();
        ...
        __freed_obj__ = 0;
        expression_node_102=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value92=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 101,expression_v13(info)))));
        ...
        __freed_obj__ = 0;
        come_clear_stackframe();
        optional$2intbool_value((come_push_stackframe("10do_while.c", 103),((struct optional$2intbool*)(right_value93=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 103,expected_next_character(41,info))))));
        ...
        _inf_obj_value1=come_increment_ref_count(((struct sDoWhileNode*)(right_value95=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 105,sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(right_value94=(struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 105)))),(struct sNode*)come_increment_ref_count(expression_node_102),block_98,info)))));
    ...
    result_104=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value106=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 112,optional$2sNodephbool_catch(((struct optional$2sNodephbool*)come_null_check((come_push_stackframe("10do_while.c", 112),((struct optional$2sNodephbool*)(right_value103=(gCallerSName[0] = "10do_while.c", gCallerSLine[0] = 112,string_node_v9(buf,head,head_sline,info))))), "10do_while.c", 112)),&__current_stack1__,(void*)method_block1_10dowhilec)))));
...
memset(&default_value_99, 0, sizeof(char*));
        memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);        memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);        for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
            ...
            _if_conditional181) {
                __freed_obj__ = 0;
                (gCallerSName[0] = "./comelang2.h", gCallerSLine[0] = 61,memset(&default_value_99,0,sizeof(char*)));
                __freed_obj__ = 0;
...
memset(&default_value_101, 0, sizeof(int));
        memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);        memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);        for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
            ...
            _if_conditional184) {
                __freed_obj__ = 0;
                (gCallerSName[0] = "./comelang2.h", gCallerSLine[0] = 61,memset(&default_value_101,0,sizeof(int)));
                __freed_obj__ = 0;
...
memset(&right_value99, 0, sizeof(void*));
        memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);        memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);        for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
            ...
            _if_conditional189) {
                ...
                ((struct sDoWhileNode*)come_null_check(result_103, "sDoWhileNode_clone", 4))->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value97=(gCallerSName[0] = "sDoWhileNode_clone", gCallerSLine[0] = 4,sNode_clone(((struct sDoWhileNode*)come_null_check(self, "sDoWhileNode_clone", 4))->mExpressionNode)))));
            ...
            _if_conditional190) {
                ...
                ((struct sDoWhileNode*)come_null_check(result_103, "sDoWhileNode_clone", 5))->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value98=(gCallerSName[0] = "sDoWhileNode_clone", gCallerSLine[0] = 5,sBlock_clone(((struct sDoWhileNode*)come_null_check(self, "sDoWhileNode_clone", 5))->mBlock)))));
            ...
            _if_conditional192) {
                ...
                ((struct sDoWhileNode*)come_null_check(result_103, "sDoWhileNode_clone", 7))->sname=(char*)come_increment_ref_count(((char*)(right_value99=(gCallerSName[0] = "sDoWhileNode_clone", gCallerSLine[0] = 7,string_clone(((struct sDoWhileNode*)come_null_check(self, "sDoWhileNode_clone", 7))->sname)))));
