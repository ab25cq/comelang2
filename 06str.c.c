...
right_value451 = (void*)0;
    ...
    while(_while_condtional42=(_Bool)1,    _while_condtional42) {
        ...
        # 1842 "06str.c"
        __dec_obj136=node_318;
        node_318=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value445=post_position_operator3_v21((struct sNode*)come_increment_ref_count(node_318),info))));
...
right_value450 = (void*)0;
        ...
        # 3 "sTupleNode_clone"
        result_319=(struct sTupleNode*)come_increment_ref_count(((struct sTupleNode*)(right_value448=(struct sTupleNode*)come_calloc(1, sizeof(struct sTupleNode)*(1), "sTupleNode_clone", 3, "sTupleNode"))));
        ...
        if(_if_conditional356=self!=((void*)0)&&self->sname!=((void*)0),        _if_conditional356) {
            # 5 "sTupleNode_clone"
            __dec_obj137=result_319->sname;
            result_319->sname=(char*)come_increment_ref_count(((char*)(right_value449=string_clone(self->sname))));
        ...
        if(_if_conditional357=self!=((void*)0)&&self->tuple_elements!=((void*)0),        _if_conditional357) {
            # 6 "sTupleNode_clone"
            __dec_obj138=result_319->tuple_elements;
            result_319->tuple_elements=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value450=list$1sNodephp_clone(self->tuple_elements))));
