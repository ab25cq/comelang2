...
gCallerSName3 = gCallerSName2, gCallerSLine3 = gCallerSLine2;
gCallerSName2 = gCallerSName, gCallerSLine2 = gCallerSLine;
    if(_if_conditional5=(gCallerSName = "22impl.c", gCallerSLine = 81, string_operator_equals(buf,"impl")),    __freed_obj__ = 0, 
    _if_conditional5) {
        come_clear_stackframe();
        word_6=(char*)come_increment_ref_count(optional$2charphbool_value((come_push_stackframe("22impl.c", 6),((struct optional$2charphbool*)(right_value10=(gCallerSName = "22impl.c", gCallerSLine = 6,parse_word(info)))))));
        come_pop_stackframe();
        ...
        _if_conditional8) {
            ...
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 10,skip_spaces_and_lf(info));
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 12,list$1charph_reset(((struct list$1charph*)come_null_check(((struct sInfo*)come_null_check(info, "22impl.c", 12))->generics_type_names, "22impl.c", 12))));
            __freed_obj__ = 0;
            while(_while_condtional2=(_Bool)1,            __freed_obj__ = 0, 
            _while_condtional2) {
                come_clear_stackframe();
                generics_name_9=(char*)come_increment_ref_count(optional$2charphbool_value((come_push_stackframe("22impl.c", 14),((struct optional$2charphbool*)(right_value11=(gCallerSName = "22impl.c", gCallerSLine = 14,parse_word(info)))))));
                ...
                __freed_obj__ = 0;
                (gCallerSName = "22impl.c", gCallerSLine = 16,list$1charph_push_back(((struct list$1charph*)come_null_check(((struct sInfo*)come_null_check(info, "22impl.c", 16))->generics_type_names, "22impl.c", 16)),(char*)come_increment_ref_count(generics_name_9)));
                __freed_obj__ = 0;
                ...
                _if_conditional12) {
                    ...
                    __freed_obj__ = 0;
                    (gCallerSName = "22impl.c", gCallerSLine = 20,skip_spaces_and_lf(info));
                    __freed_obj__ = 0;
                }
                else {
                    ...
                    _if_conditional13) {
                        ...
                        __freed_obj__ = 0;
                        (gCallerSName = "22impl.c", gCallerSLine = 24,skip_spaces_and_lf(info));
                        __freed_obj__ = 0;
                        ...
                        (gCallerSName = "22impl.c", gCallerSLine = 28,err_msg(info,"invalid character on impl (%c)",*((struct sInfo*)come_null_check(info, "22impl.c", 28))->p));
                        __freed_obj__ = 0;
                        (gCallerSName = "22impl.c", gCallerSLine = 29,exit(2));
                        __freed_obj__ = 0;
                    }
                    __freed_obj__ = 0;
                }
        ...
        _while_condtional3) {
            ...
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 37,skip_spaces_and_lf(info));
            __freed_obj__ = 0;
            pointer_num_13++;
            __freed_obj__ = 0;
        }
        __freed_obj__ = 0;
        come_clear_stackframe();
        optional$2intbool_value((come_push_stackframe("22impl.c", 41),((struct optional$2intbool*)(right_value15=(gCallerSName = "22impl.c", gCallerSLine = 41,expected_next_character(123,info))))));
        come_pop_stackframe();
        ...
        ((struct sInfo*)come_null_check(info, "22impl.c", 43))->impl_type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value17=(gCallerSName = "22impl.c", gCallerSLine = 43,sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value16=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "22impl.c", 43)))),word_6,(_Bool)0,info)))));
        ...
        _while_condtional7) {
            (gCallerSName = "22impl.c", gCallerSLine = 47,parse_sharp_v5(info));
            __freed_obj__ = 0;
            head_21=((struct sInfo*)come_null_check(info, "22impl.c", 49))->p;
            __freed_obj__ = 0;
            come_clear_stackframe();
            buf_22=(char*)come_increment_ref_count(optional$2charphbool_value((come_push_stackframe("22impl.c", 50),((struct optional$2charphbool*)(right_value18=(gCallerSName = "22impl.c", gCallerSLine = 50,parse_word(info)))))));
            ...
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 52,parse_sharp_v5(info));
            __freed_obj__ = 0;
            node_23=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value19=(gCallerSName = "22impl.c", gCallerSLine = 54,top_level_v99((char*)come_increment_ref_count(buf_22),head_21,head_sline,info)))));
            ...
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 55,parse_sharp_v5(info));
            __freed_obj__ = 0;
            ...
            _while_condtional8) {
                ...
                __freed_obj__ = 0;
                (gCallerSName = "22impl.c", gCallerSLine = 59,skip_spaces_and_lf(info));
                __freed_obj__ = 0;
            }
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 61,parse_sharp_v5(info));
            __freed_obj__ = 0;
            ...
            _if_conditional30) {
                ...
                _if_conditional31) {
                    (gCallerSName = "22impl.c", gCallerSLine = 65,err_msg(info,"compiling is faield(Y)"));
                    __freed_obj__ = 0;
                    (gCallerSName = "22impl.c", gCallerSLine = 66,exit(2));
                    __freed_obj__ = 0;
                }
                __freed_obj__ = 0;
            }
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 69,parse_sharp_v5(info));
            __freed_obj__ = 0;
            (gCallerSName = "22impl.c", gCallerSLine = 71,skip_spaces_and_lf(info));
            __freed_obj__ = 0;
        ...
        __freed_obj__ = 0;
        come_clear_stackframe();
        optional$2intbool_value((come_push_stackframe("22impl.c", 74),((struct optional$2intbool*)(right_value20=(gCallerSName = "22impl.c", gCallerSLine = 74,expected_next_character(125,info))))));
        ...
        __freed_obj__ = 0;
        (gCallerSName = "22impl.c", gCallerSLine = 75,list$1charph_reset(((struct list$1charph*)come_null_check(((struct sInfo*)come_null_check(info, "22impl.c", 75))->generics_type_names, "22impl.c", 75))));
        __freed_obj__ = 0;
    ...
    __freed_obj__ = 0;
    __result19__ = __result_obj__ = ((struct sNode*)(right_value22=(gCallerSName = "22impl.c", gCallerSLine = 81,top_level_v92((char*)come_increment_ref_count(((char*)(right_value21=(gCallerSName = "22impl.c", gCallerSLine = 81,__builtin_string(buf))))),head,head_sline,info))));
    if(buf && !__freed_obj__) { buf = come_decrement_ref_count(buf, (void*)0, (void*)0, 0, 1, 0); }
...
memset(&default_value_5, 0, sizeof(char*));
        ...
        gCallerSName2 = gCallerSName, gCallerSLine2 = gCallerSLine;
            ...
            _if_conditional6) {
                __freed_obj__ = 0;
                (gCallerSName = "./comelang2.h", gCallerSLine = 61,memset(&default_value_5,0,sizeof(char*)));
                __freed_obj__ = 0;
...
memset(&prev_it_8, 0, sizeof(struct list_item$1charph*));
            ...
            gCallerSName3 = gCallerSName2, gCallerSLine3 = gCallerSLine2;
            gCallerSName2 = gCallerSName, gCallerSLine2 = gCallerSLine;
                it_7=((struct list$1charph*)come_null_check(self, "./comelang2.h", 497))->head;
                __freed_obj__ = 0;
                while(_while_condtional1=it_7!=((void*)0),                __freed_obj__ = 0, 
                _while_condtional1) {
                    prev_it_8=it_7;
                    __freed_obj__ = 0;
                    it_7=((struct list_item$1charph*)come_null_check(it_7, "./comelang2.h", 500))->next;
                    __freed_obj__ = 0;
...
memset(&litem_12, 0, sizeof(struct list_item$1charph*));
                ...
                gCallerSName3 = gCallerSName2, gCallerSLine3 = gCallerSLine2;
                gCallerSName2 = gCallerSName, gCallerSLine2 = gCallerSLine;
                    if(_if_conditional10=((struct list$1charph*)come_null_check(self, "./comelang2.h", 323))->len==0,                    __freed_obj__ = 0, 
                    _if_conditional10) {
                        litem_10=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value12=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 293))));
                        ...
                        __freed_obj__ = 0;
                        ((struct list_item$1charph*)come_null_check(litem_10, "./comelang2.h", 295))->prev=((void*)0);
                        __freed_obj__ = 0;
                        ((struct list_item$1charph*)come_null_check(litem_10, "./comelang2.h", 296))->next=((void*)0);
                        __freed_obj__ = 0;
                        __dec_obj6=((struct list_item$1charph*)come_null_check(litem_10, "./comelang2.h", 297))->item;
                        ((struct list_item$1charph*)come_null_check(litem_10, "./comelang2.h", 297))->item=(char*)come_increment_ref_count(item);
                        if(__dec_obj6) { __dec_obj6 = come_decrement_ref_count(__dec_obj6, (void*)0, (void*)0, 0,0,0); }
                        __freed_obj__ = 0;
                        ((struct list$1charph*)come_null_check(self, "./comelang2.h", 299))->tail=litem_10;
                        __freed_obj__ = 0;
                        ((struct list$1charph*)come_null_check(self, "./comelang2.h", 300))->head=litem_10;
                        __freed_obj__ = 0;
                    }
                    else {
                        if(_if_conditional11=((struct list$1charph*)come_null_check(self, "./comelang2.h", 323))->len==1,                        __freed_obj__ = 0, 
                        _if_conditional11) {
                            litem_11=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value13=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 303))));
                            ...
                            __freed_obj__ = 0;
                            ((struct list_item$1charph*)come_null_check(litem_11, "./comelang2.h", 305))->prev=((struct list$1charph*)come_null_check(self, "./comelang2.h", 305))->head;
                            __freed_obj__ = 0;
                            ((struct list_item$1charph*)come_null_check(litem_11, "./comelang2.h", 306))->next=((void*)0);
                            __freed_obj__ = 0;
                            __dec_obj7=((struct list_item$1charph*)come_null_check(litem_11, "./comelang2.h", 307))->item;
                            ((struct list_item$1charph*)come_null_check(litem_11, "./comelang2.h", 307))->item=(char*)come_increment_ref_count(item);
                            if(__dec_obj7) { __dec_obj7 = come_decrement_ref_count(__dec_obj7, (void*)0, (void*)0, 0,0,0); }
                            __freed_obj__ = 0;
                            ((struct list$1charph*)come_null_check(self, "./comelang2.h", 309))->tail=litem_11;
                            __freed_obj__ = 0;
                            ((struct list_item$1charph*)come_null_check(((struct list$1charph*)come_null_check(self, "./comelang2.h", 310))->head, "./comelang2.h", 310))->next=litem_11;
                            __freed_obj__ = 0;
                        }
                        else {
                            litem_12=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value14=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 313))));
                            ...
                            __freed_obj__ = 0;
                            ((struct list_item$1charph*)come_null_check(litem_12, "./comelang2.h", 315))->prev=((struct list$1charph*)come_null_check(self, "./comelang2.h", 315))->tail;
                            __freed_obj__ = 0;
                            ((struct list_item$1charph*)come_null_check(litem_12, "./comelang2.h", 316))->next=((void*)0);
                            __freed_obj__ = 0;
                            __dec_obj8=((struct list_item$1charph*)come_null_check(litem_12, "./comelang2.h", 317))->item;
                            ((struct list_item$1charph*)come_null_check(litem_12, "./comelang2.h", 317))->item=(char*)come_increment_ref_count(item);
                            if(__dec_obj8) { __dec_obj8 = come_decrement_ref_count(__dec_obj8, (void*)0, (void*)0, 0,0,0); }
                            __freed_obj__ = 0;
                            ((struct list_item$1charph*)come_null_check(((struct list$1charph*)come_null_check(self, "./comelang2.h", 319))->tail, "./comelang2.h", 319))->next=litem_12;
                            __freed_obj__ = 0;
                            ((struct list$1charph*)come_null_check(self, "./comelang2.h", 320))->tail=litem_12;
                            __freed_obj__ = 0;
                        }
                        __freed_obj__ = 0;
                    }
...
memset(&default_value_14, 0, sizeof(int));
        ...
        gCallerSName2 = gCallerSName, gCallerSLine2 = gCallerSLine;
            ...
            _if_conditional14) {
                __freed_obj__ = 0;
                (gCallerSName = "./comelang2.h", gCallerSLine = 61,memset(&default_value_14,0,sizeof(int)));
                __freed_obj__ = 0;
...
memset(&prev_it_18, 0, sizeof(struct list_item$1sNodeph*));
                ...
                gCallerSName3 = gCallerSName2, gCallerSLine3 = gCallerSLine2;
                gCallerSName2 = gCallerSName, gCallerSLine2 = gCallerSLine;
                    it_17=((struct list$1sNodeph*)come_null_check(self, "./comelang2.h", 190))->head;
                    __freed_obj__ = 0;
                    while(_while_condtional5=it_17!=((void*)0),                    __freed_obj__ = 0, 
                    _while_condtional5) {
                        prev_it_18=it_17;
                        __freed_obj__ = 0;
                        it_17=((struct list_item$1sNodeph*)come_null_check(it_17, "./comelang2.h", 193))->next;
                        __freed_obj__ = 0;
...
memset(&prev_it_20, 0, sizeof(struct list_item$1charph*));
                ...
                gCallerSName3 = gCallerSName2, gCallerSLine3 = gCallerSLine2;
                gCallerSName2 = gCallerSName, gCallerSLine2 = gCallerSLine;
                    it_19=((struct list$1charph*)come_null_check(self, "./comelang2.h", 190))->head;
                    __freed_obj__ = 0;
                    while(_while_condtional6=it_19!=((void*)0),                    __freed_obj__ = 0, 
                    _while_condtional6) {
                        prev_it_20=it_19;
                        __freed_obj__ = 0;
                        it_19=((struct list_item$1charph*)come_null_check(it_19, "./comelang2.h", 193))->next;
                        __freed_obj__ = 0;
