...
right_value90 = (void*)0;
                ...
                # 143 "./neo-c.h"
                result_51=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value86=list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value85=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "./neo-c.h", 143, "list$1sNodeph"))))))));
...
memset(&litem_55, 0, sizeof(struct list_item$1sNodeph*));
                        ...
                        if(_if_conditional37=self->len==0,                        _if_conditional37) {
                            # 157 "./neo-c.h"
                            litem_53=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value87=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 157, "list_item$1sNodeph"))));
                            ...
                            if(_if_conditional38=self->len==1,                            _if_conditional38) {
                                # 167 "./neo-c.h"
                                litem_54=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value88=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 167, "list_item$1sNodeph"))));
                                ...
                                # 177 "./neo-c.h"
                                litem_55=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value89=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./neo-c.h", 177, "list_item$1sNodeph"))));
...
memset(&it2_77, 0, sizeof(struct sVar*));
                        ...
                        # 1182 "./neo-c.h"
                        result_68=(struct map$2charphsVarph*)come_increment_ref_count(((struct map$2charphsVarph*)(right_value99=map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count(((struct map$2charphsVarph*)(right_value93=(struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "./neo-c.h", 1182, "map$2charphsVarph"))))))));
                        ...
                        result_68->key_list=(struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value101=list$1charp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value100=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./neo-c.h", 1184, "list$1charp"))))))));
...
right_value98 = (void*)0;
                            # 1088 "./neo-c.h"
                            self->keys=(char**)come_increment_ref_count(((char**)(right_value94=(char**)come_calloc(1, sizeof(char*)*(1*(1024)), "./neo-c.h", 1088, "char*%"))));
                            right_value94 = come_decrement_ref_count2(right_value94, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                            # 1089 "./neo-c.h"
                            self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(right_value95=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(1024)), "./neo-c.h", 1089, "sVar*%"))));
                            come_call_finalizer3(right_value95,sVar_finalize, 0, 1, 0, 0, __result_obj__);
                            # 1090 "./neo-c.h"
                            self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(right_value96=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(1024)), "./neo-c.h", 1090, "bool"))));
                            ...
                            self->key_list=(struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value98=list$1charp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value97=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "./neo-c.h", 1100, "list$1charp"))))))));
...
memset(&default_value_88, 0, sizeof(struct sVar*));
                                        ...
                                        # 1339 "./neo-c.h"
                                        keys_79=(char**)come_increment_ref_count(((char**)(right_value102=(char**)come_calloc(1, sizeof(char*)*(1*(size_78)), "./neo-c.h", 1339, "char*%"))));
                                        right_value102 = come_decrement_ref_count2(right_value102, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                                        # 1340 "./neo-c.h"
                                        items_80=(struct sVar**)come_increment_ref_count(((struct sVar**)(right_value103=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_78)), "./neo-c.h", 1340, "sVar*%"))));
                                        come_call_finalizer3(right_value103,sVar_finalize, 0, 1, 0, 0, __result_obj__);
                                        # 1341 "./neo-c.h"
                                        item_existance_81=(_Bool*)come_increment_ref_count(((_Bool*)(right_value104=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_78)), "./neo-c.h", 1341, "bool"))));
...
memset(&litem_115, 0, sizeof(struct list_item$1charp*));
                                        ...
                                        if(_if_conditional112=self->len==0,                                        _if_conditional112) {
                                            # 227 "./neo-c.h"
                                            litem_113=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value105=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "./neo-c.h", 227, "list_item$1charp"))));
                                            ...
                                            if(_if_conditional113=self->len==1,                                            _if_conditional113) {
                                                # 237 "./neo-c.h"
                                                litem_114=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value106=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "./neo-c.h", 237, "list_item$1charp"))));
                                                ...
                                                # 247 "./neo-c.h"
                                                litem_115=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value107=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "./neo-c.h", 247, "list_item$1charp"))));
...
memset(&conditional_value3_134, 0, sizeof(struct CVALUE*));
    ...
    # 61 "11for.c"
    for_var_table_121=(struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value113=sVarTable_initialize((struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value112=(struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "11for.c", 61, "sVarTable")))),(_Bool)0,lv_table_120))));
...
right_value134 = (void*)0;
    ...
    if(_if_conditional140=charp_operator_equals(buf,"for"),    _if_conditional140) {
        ...
        if(_if_conditional141=*info->p==59,        _if_conditional141) {
            ...
            expression_node_135=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value121=expression_v13(info))));
        ...
        if(_if_conditional142=*info->p==59,        _if_conditional142) {
            ...
            expression_node2_136=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value122=expression_v13(info))));
        ...
        if(_if_conditional143=*info->p==41,        _if_conditional143) {
            ...
            expression_node3_137=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value123=expression_v13(info))));
        ...
        parse_sharp_v5(info);
        # 479 "11for.c"
        block_138=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value124=parse_block(info,(_Bool)0,(_Bool)0))));
        come_call_finalizer3(right_value124,sBlock_finalize, 0, 1, 0, 0, __result_obj__);
        # 481 "11for.c"
...
memset(&__result_obj__, 0, sizeof(void*));
            # 1 "sForNode_finalize"
            # 0 "sForNode_finalize"
            if(_if_conditional144=self!=((void*)0)&&self->mExpressionNode!=((void*)0),            _if_conditional144) {
                # 0 "sForNode_finalize"
            ...
            # 2 "sForNode_finalize"
            # 1 "sForNode_finalize"
            if(_if_conditional145=self!=((void*)0)&&self->mExpressionNode2!=((void*)0),            _if_conditional145) {
                # 1 "sForNode_finalize"
            ...
            # 3 "sForNode_finalize"
            # 2 "sForNode_finalize"
            if(_if_conditional146=self!=((void*)0)&&self->mExpressionNode3!=((void*)0),            _if_conditional146) {
                # 2 "sForNode_finalize"
...
right_value132 = (void*)0;
            ...
            # 3 "sForNode_clone"
            result_139=(struct sForNode*)come_increment_ref_count(((struct sForNode*)(right_value127=(struct sForNode*)come_calloc(1, sizeof(struct sForNode)*(1), "sForNode_clone", 3, "sForNode"))));
            come_call_finalizer3(right_value127,sForNode_finalize, 0, 1, 0, 0, __result_obj__);
            # 5 "sForNode_clone"
            # 4 "sForNode_clone"
            ...
            # 6 "sForNode_clone"
            # 5 "sForNode_clone"
            if(_if_conditional151=self!=((void*)0)&&self->mExpressionNode2!=((void*)0),            _if_conditional151) {
                # 5 "sForNode_clone"
            ...
            # 7 "sForNode_clone"
            # 6 "sForNode_clone"
            if(_if_conditional152=self!=((void*)0)&&self->mExpressionNode3!=((void*)0),            _if_conditional152) {
                # 6 "sForNode_clone"
            ...
            # 8 "sForNode_clone"
            # 7 "sForNode_clone"
            if(_if_conditional153=self!=((void*)0)&&self->mBlock!=((void*)0),            _if_conditional153) {
                # 7 "sForNode_clone"
            ...
            if(_if_conditional155=self!=((void*)0)&&self->sname!=((void*)0),            _if_conditional155) {
                # 9 "sForNode_clone"
                __dec_obj42=result_139->sname;
                result_139->sname=(char*)come_increment_ref_count(((char*)(right_value132=string_clone(self->sname))));
