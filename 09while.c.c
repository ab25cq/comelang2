...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    ...
    ((struct sWhileNode*)come_null_check(self, "09while.c", 16))->sname=(char*)come_increment_ref_count(((char*)(right_value10=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 16,__builtin_string(((struct sInfo*)come_null_check(info, "09while.c", 16))->sname)))));
    if(__dec_obj6) { __dec_obj6 = come_decrement_ref_count(__dec_obj6, (void*)0, (void*)0, 0,0,0); }
    if(right_value10 && right_value10 != __result_obj__ && !__freed_obj__) { right_value10 = come_decrement_ref_count(right_value10, (void*)0, (void*)0, 1, 0, 0); }
    __freed_obj__ = 0;
    __dec_obj7=((struct sWhileNode*)come_null_check(self, "09while.c", 18))->mExpressionNode;
    ((struct sWhileNode*)come_null_check(self, "09while.c", 18))->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value12=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 18,sNode_clone(expression_node)))));
    ...
    ((struct sWhileNode*)come_null_check(self, "09while.c", 19))->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value84=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 19,sBlock_clone(block)))));
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    __result74__ = __result_obj__ = ((char*)(right_value85=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 31,__builtin_string("sWhileNode"))));
    __freed_obj__ = 0;
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    ...
    __freed_obj__ = 0;
    conditional_value_92=(struct CVALUE*)come_increment_ref_count(((struct CVALUE*)(right_value86=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 48,get_value_from_stack(-1,info)))));
    ...
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 49,dec_stack_ptr(1,info));
    __freed_obj__ = 0;
    block_93=((struct sWhileNode*)come_null_check(self, "09while.c", 51))->mBlock;
    __freed_obj__ = 0;
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 54,add_come_code_at_function_head(info,"_Bool _while_condtional%d;\n",++num_while_condtional_94));
    __freed_obj__ = 0;
    num_while_conditional_stack_95=num_while_condtional_94;
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 57,add_come_code(info,"while(_while_condtional%d=%s,",num_while_condtional_94,((struct CVALUE*)come_null_check(conditional_value_92, "09while.c", 57))->c_value));
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 58,add_last_code_to_source_with_comma(info));
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 59,free_right_value_objects(info,(_Bool)1));
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 60,add_come_code(info,"_while_condtional%d) {\n",num_while_conditional_stack_95));
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 62,transpile_block(block_93,((void*)0),((void*)0),info,(_Bool)0,(_Bool)1));
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 64,add_come_code(info,"}\n"));
    __freed_obj__ = 0;
    (gCallerSName[0] = "09while.c", gCallerSLine[0] = 66,transpiler_clear_last_code(info));
    __freed_obj__ = 0;
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    __result78__ = __result_obj__ = ((char*)(right_value87=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 80,__builtin_string(((struct sWhileNode*)come_null_check(self, "09while.c", 80))->sname))));
    __freed_obj__ = 0;
...
memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
    if(_if_conditional180=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 101, charp_operator_equals(buf,"while")),    __freed_obj__ = 0, 
    _if_conditional180) {
        sname_96=(char*)come_increment_ref_count(((char*)(right_value88=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 86,string_clone(((struct sInfo*)come_null_check(info, "09while.c", 86))->sname)))));
        if(right_value88 && right_value88 != __result_obj__ && !__freed_obj__) { right_value88 = come_decrement_ref_count(right_value88, (void*)0, (void*)0, 1, 0, 0); }
        __freed_obj__ = 0;
        sline_97=((struct sInfo*)come_null_check(info, "09while.c", 87))->sline;
        __freed_obj__ = 0;
        optional$2intbool_value((come_push_stackframe("09while.c", 89),((struct optional$2intbool*)(right_value89=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 89,expected_next_character(40,info))))));
        come_pop_stackframe();
        ...
        __freed_obj__ = 0;
        expression_node_99=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value90=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 92,expression_v13(info)))));
        ...
        __freed_obj__ = 0;
        optional$2intbool_value((come_push_stackframe("09while.c", 94),((struct optional$2intbool*)(right_value91=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 94,expected_next_character(41,info))))));
        ...
        __freed_obj__ = 0;
        block_100=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value92=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 96,parse_block(info,(_Bool)0)))));
        ...
        _inf_obj_value1=come_increment_ref_count(((struct sWhileNode*)(right_value94=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 98,sWhileNode_initialize((struct sWhileNode*)come_increment_ref_count(((struct sWhileNode*)(right_value93=(struct sWhileNode*)come_calloc(1, sizeof(struct sWhileNode)*(1), "09while.c", 98)))),(struct sNode*)come_increment_ref_count(expression_node_99),block_100,info)))));
    ...
    result_102=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value105=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 105,optional$2sNodephbool_catch(((struct optional$2sNodephbool*)come_null_check((come_push_stackframe("09while.c", 105),((struct optional$2sNodephbool*)(right_value102=(gCallerSName[0] = "09while.c", gCallerSLine[0] = 105,string_node_v8(buf,head,head_sline,info))))), "09while.c", 105)),&__current_stack1__,(void*)method_block1_09whilec)))));
...
memset(&default_value_98, 0, sizeof(int));
        memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);        memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);        for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
            ...
            _if_conditional181) {
                __freed_obj__ = 0;
                (gCallerSName[0] = "./comelang2.h", gCallerSLine[0] = 61,memset(&default_value_98,0,sizeof(int)));
                __freed_obj__ = 0;
...
memset(&right_value98, 0, sizeof(void*));
        memcpy(__caller_sname__, gCallerSName, sizeof(char*)*10);        memcpy(__caller_sline__, gCallerSLine, sizeof(int)*10);        for(__caller_i__=10-1; __caller_i__>=1; __caller_i__--) { gCallerSName[__caller_i__] = gCallerSName[__caller_i__-1]; gCallerSLine[__caller_i__] = gCallerSLine[__caller_i__-1]; } 
            ...
            _if_conditional186) {
                ...
                ((struct sWhileNode*)come_null_check(result_101, "sWhileNode_clone", 4))->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value96=(gCallerSName[0] = "sWhileNode_clone", gCallerSLine[0] = 4,sNode_clone(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 4))->mExpressionNode)))));
            ...
            _if_conditional187) {
                ...
                ((struct sWhileNode*)come_null_check(result_101, "sWhileNode_clone", 5))->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value97=(gCallerSName[0] = "sWhileNode_clone", gCallerSLine[0] = 5,sBlock_clone(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 5))->mBlock)))));
            ...
            _if_conditional189) {
                ...
                ((struct sWhileNode*)come_null_check(result_101, "sWhileNode_clone", 7))->sname=(char*)come_increment_ref_count(((char*)(right_value98=(gCallerSName[0] = "sWhileNode_clone", gCallerSLine[0] = 7,string_clone(((struct sWhileNode*)come_null_check(self, "sWhileNode_clone", 7))->sname)))));
